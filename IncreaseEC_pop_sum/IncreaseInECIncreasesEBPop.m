...
for PercetangeEMTCellCount=[60 90]
    ...
    for LigandDensity=[1]          
        ...
        % For LD=1
         EcConcentrationTemp=EcConcentrationTemp*3;
        
        %For LD=5
         %EcConcentrationTemp=EcConcentrationTemp*7;
         
         % For LD=10
         %EcConcentrationTemp=EcConcentrationTemp*15;
         
         % For LD=20
         %EcConcentrationTemp=EcConcentrationTemp*25;
